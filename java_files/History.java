...
public class History extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            String s = String.format("select pid from passenger where name='%s'", name);
            ...
            histList = "<table border='2' cellspacing='3' cellpadding='30'  background-color='#04AA6D' color='white' bordercolor='brown' align='center'><tr><th>Name</th><th>Ticket Number</th><th>Flight id</th><th>Date of Travel</th><th>No.of.Seats</th><th>Status</th></tr>";
            while(rs1.next()) {
