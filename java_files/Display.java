...
public class Display extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            // pw.println("testing");
            trlistcontent = "<table id='trainlist' border='2' cellspacing='3' cellpadding='8'  background-color='#04AA6D' color='white' bordercolor='brown' align='center'><tr><th>Flight Name</th><th>Flight Number</th><th>Price</th><th>Source</th><th>Destination</th><th>Available Seats</th><th>Duration</th></tr>";
            for(int i = 0; i < trlist.length; i++) {
                if(trlist[i][0] != null) {
                    trlistcontent += "<tr>";
