...
public class SearchTrain extends HttpServlet {
    public String[][] getTrains(String src, String dest) throws Exception {
        ...
        try {
            ...
            System.out.println("Hey I am after forname method in getFlights() - SearchFlight class");
            
            Connection con = DriverManager.getConnection(url, sqluser, sqlpwd);

            Statement st = con.createStatement();

            System.out.println("Hey I am after create method in getFlights() - SearchFlight class");

            String s = String.format("select * from flight where source = '%s' and destination = '%s'", src, dest);
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            // pw.println("testing");
            trlistcontent = "<table id='trainlist' border='2' cellspacing='3' cellpadding='8'  background-color='#04AA6D' color='white' bordercolor='brown' align='center'><tr><th>Flight Number</th><th>Flight Name</th><th>Price</th><th>Source</th><th>Destination</th><th>Available Seats</th><th>Duration</th><th>Book Now</th></tr> ";
            for(int i = 0; i < trlist.length; i++) {
                if(trlist[i][0] != null) {
                    trlistcontent += "<tr>";
