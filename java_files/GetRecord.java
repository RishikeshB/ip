...
public class GetRecord extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            s = String.format("select name,source,destination from flight where tid='%d'", tid);
            ...
            record = "<table border='2' cellspacing='3' cellpadding='30' background-color='#04AA6D' color='white' bordercolor='brown' style='margin-left:420px;margin-top: 30px;'><tr><th>Ticket No.</th><th>Passenger Name</th><th>Flight Number</th><th>Flight Name</th><th>Source</th><th>Destination</th><th>Date of Travel</th><th>No of Seats</th><th>Cancel Now</th></tr>";
            record += "<tr>";
